    ...
    <View style={styles.container}>
      <ScrollView style={styles.postContainer}>
        ...
        <View style={styles.comment}>
          <Image source={{ uri: require('../pictures/crispy.png') }} style={styles.commentProfilePic} />
        ...
        <View style={styles.comment}>
          <Image source={{ uri: require('../pictures/dog.jpg') }} style={styles.commentProfilePic} />
          <View style={styles.commentBox}>
        ...
        <View style={styles.comment}>
          <Image source={{ uri: require('../pictures/robber.png') }} style={styles.commentProfilePic} />
          <View style={styles.commentBox}>
        ...
        <View style={styles.comment}>
          <Image source={{ uri: require('../pictures/king.jpg') }} style={styles.commentProfilePic} />
          <View style={styles.commentBox}>
